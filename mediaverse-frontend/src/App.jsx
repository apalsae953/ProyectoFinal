      ...
      <div style={{ backgroundColor: '#121212', minHeight: '100vh', fontFamily: 'sans-serif', position: 'relative' }}>
        ...
        <nav style={{ padding: '20px', backgroundColor: '#000', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
            <Link to="/dashboard" style={{ textDecoration: 'none', transition: 'transform 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
              <h2 style={{ color: '#e50914', margin: 0, display: 'flex', alignItems: 'center', gap: '10px' }}><i className="fa-solid fa-clapperboard"></i> Mediaverse</h2>
            </Link>
                ...
                {cineMenuAbierto && (
                  <motion.div 
                    ...
                    style={{ 
                      ...
                      marginTop: '5px' // Pequeña separación visual, pero el 'hover' se mantiene por el padding del padre
                    }}
                  >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '30px' }}>
            ...
            {isLogged ? (
              <Link to="/perfil" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none', color: 'white', backgroundColor: '#111', padding: '5px 15px', borderRadius: '30px', border: '1px solid #333', transition: 'all 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#e50914'} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#333'}>
                <span style={{ fontSize: '14px', fontWeight: 'bold' }}>{user?.name?.split(' ')[0] || 'Cargando...'}</span>
                <img 
              ...
              <Link to="/auth" style={{ color: 'white', textDecoration: 'none', fontSize: '14px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px', hover: { color: '#e50914' } }} onMouseEnter={(e) => e.target.style.color = '#e50914'} onMouseLeave={(e) => e.target.style.color = 'white'}>
                <i className="fa-solid fa-circle-user" style={{ fontSize: '20px' }}></i> Registrarse / Iniciar Sesión
              </Link>
            )}
              ...
              <div 
                ...
                {isLogged ? (
                  <>
                    ...
                    <Link to="/rankings" onClick={() => setMenuAbierto(false)} style={{ color: '#ccc', textDecoration: 'none', fontSize: '16px', transition: 'padding-left 0.3s' }} onMouseEnter={(e) => e.target.style.paddingLeft = '10px'} onMouseLeave={(e) => e.target.style.paddingLeft = '0'}><i className="fa-solid fa-ranking-star"></i> Rankings</Link>
