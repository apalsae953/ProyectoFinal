 ...
 */
function YaVistos() {
    const [vistos, setVistos] = useState([]); // Lista de medios ya vistos/jugados
    const [ratings, setRatings] = useState({}); // Mapa de medio_id -> puntuacion
    const [cargando, setCargando] = useState(true); // Control del spinner de carga
    const [editingDateId, setEditingDateId] = useState(null); // ID de la interacción cuya fecha se está editando
